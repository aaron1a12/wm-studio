...
protected:
	...
	static INT_PTR CALLBACK XMessageBoxDlgProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM me);
...
///////////////////////////////////////////////////////////////////////////////
// XMessageBoxDlgProc
INT_PTR CALLBACK CXDialogTemplate::XMessageBoxDlgProc(HWND hwnd,
												 UINT message,
												 WPARAM wParam,
												 LPARAM lParam)
{
	...
	switch (message)
	{
		...
		case WM_INITDIALOG:
		{
			TRACE(_T("in CXDialogTemplate::XMessageBoxDlgProc - WM_INITDIALOG\n"));
			//m_hWnd = hwnd;
...
int CXDialogTemplate::Display()
{
	...
	// NOTE - font is set in XMessageBoxDlgProc
	...
	*(WORD*)pdest = 0;		// use default window class		//+++1.5
	...
	HWND hDlg = ::CreateDialogIndirectParam(hInstance, (LPCDLGTEMPLATE) pBuffer,
		m_hWndOwner, XMessageBoxDlgProc, (LPARAM) this);
	_ASSERTE(hDlg);
